...
server_dict = {
    'mini':{
        ...
        'data_path': '/home/gbhatt/scratch/concept_learning/data/mini_imagenet/'
        },  
    'fc100':{
        'dataset': 'fc100',
        'dataset_name': 'FC100',
        'data_path': '/home/gbhatt/scratch/concept_learning/data/FC100/'
        },
    'tiered':{
        'dataset': 'tiered',
        'dataset_name': 'tiered-imagenet',
        'data_path': '/home/gbhatt/scratch/concept_learning/data/tiered_imagenet/'
        },
    'cub':{
        'dataset': 'cub',
        'dataset_name': 'cub',
        'samples_per_class':60,
        'data_path': '/home/gbhatt/scratch/concept_learning/data/CUB_200_2011/'
        },
}
...
def eval_valtest(args):
    ...
    if 'mini' in dataset_name or 'tiered' in dataset_name or 'cub' in dataset_name:
